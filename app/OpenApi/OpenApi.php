...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'category_bg_path', type: 'integer', nullable: true, example: 1),
        new OA\Property(property: 'bg_url', type: 'string', format: 'uri', nullable: true),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'icon_url', type: 'string', format: 'uri', nullable: true),
        new OA\Property(property: 'icon_thumbnail_url', type: 'string', format: 'uri', nullable: true),
        new OA\Property(property: 'icon_thumbnail_bg', type: 'integer', nullable: true, example: 3),
        new OA\Property(property: 'bg_url', type: 'string', format: 'uri', nullable: true),
        new OA\Property(property: 'audio_url', type: 'string', format: 'uri', nullable: true),
        new OA\Property(property: 'sort_order', type: 'integer', nullable: true, example: 10),
        new OA\Property(property: 'is_premium', type: 'boolean', example: false),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'image_thumbnail_bg', type: 'integer', nullable: true, example: 5),
        new OA\Property(property: 'bg_url', type: 'string', format: 'uri', nullable: true),
        new OA\Property(property: 'sort_order', type: 'integer', nullable: true, example: 10),
        new OA\Property(property: 'is_premium', type: 'boolean', example: false),
    ]
