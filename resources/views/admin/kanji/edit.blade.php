...
<div class="bg-white rounded-lg border border-zinc-200 overflow-hidden">
    <div class="flex items-center gap-3 px-5 py-3 border-b border-zinc-100">
        <span class="text-3xl">{{ $kanji->kanji }}</span>
        <div>
            <p class="text-sm font-semibold text-zinc-900">Edit Kanji</p>
            <p class="text-xs text-zinc-400 mt-0.5">ID #{{ $kanji->id }}</p>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.kanji.update', $kanji) }}">
        @csrf
        @method('PUT')
        ...
        <div class="p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="kanji" value="{{ old('kanji', $kanji->kanji) }}" placeholder="e.g. 一"
                ...
                <div>
                    ...
                    <select name="jlpt" class="flex h-8 w-full rounded-md border {{ $errors->has('jlpt') ? 'border-red-400' : 'border-zinc-200' }} bg-white px-3 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-0">
                        ...
                        @foreach (['N5', 'N4', 'N3', 'N2', 'N1'] as $level)
                            <option value="{{ $level }}" @selected(old('jlpt', $kanji->jlpt) === $level)>{{ $level }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="vocab_id" value="{{ old('vocab_id', $kanji->vocab_id) }}" min="0" placeholder="optional"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="translate" value="{{ old('translate', $kanji->translate) }}" placeholder="e.g. One"
                ...
                <div>
                    ...
                    <input type="text" name="meanings" value="{{ old('meanings', $kanji->meanings) }}" placeholder="e.g. One, Single"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="readings_on" value="{{ old('readings_on', $kanji->readings_on) }}" placeholder="e.g. いち, いつ"
                ...
                <div>
                    ...
                    <input type="text" name="readings_kun" value="{{ old('readings_kun', $kanji->readings_kun) }}" placeholder="e.g. ひと, ひとつ"
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="number" name="strokes" value="{{ old('strokes', $kanji->strokes) }}" min="0"
                ...
                <div>
                    ...
                    <input type="number" name="grade" value="{{ old('grade', $kanji->grade) }}" min="0" placeholder="1–8"
                ...
                <div>
                    ...
                    <input type="number" name="freq" value="{{ old('freq', $kanji->freq) }}" min="0"
                ...
                <div>
                    ...
                    <input type="number" name="level" value="{{ old('level', $kanji->level) }}" min="0" placeholder="lesson level"
            ...
            <div>
                ...
                <input type="text" name="radicals" value="{{ old('radicals', $kanji->radicals) }}" placeholder="e.g. Ground, Two"
            ...
            <div>
                <label class="flex items-center gap-2 cursor-pointer select-none">
                    ...
                    <input type="checkbox" name="is_premium" value="1" {{ old('is_premium', $kanji->is_premium) ? 'checked' : '' }}
