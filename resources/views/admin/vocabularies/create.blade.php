    ...
    <form method="POST" action="{{ route('admin.vocabularies.store') }}" enctype="multipart/form-data">
        ...
        <div class="px-5 py-4 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="meaning_en" value="{{ old('meaning_en') }}" placeholder="e.g. dog"
                ...
                <div>
                    ...
                    <select name="jlpt_level"
                        ...
                        @foreach (['N5', 'N4', 'N3', 'N2', 'N1'] as $level)
                            <option value="{{ $level }}" {{ old('jlpt_level') === $level ? 'selected' : '' }}>{{ $level }}</option>
                        @endforeach
                    </select>
