...
<div class="bg-white rounded-lg border border-zinc-200 overflow-hidden">
    ...
    <form method="POST" action="{{ route('admin.vocab.categories.update', $category) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-image-preview name="icon_path" :current="$category->icon_path ? Storage::url($category->icon_path) : null">
                        @error('icon_path')
                            <p class="mt-1 text-[10px] text-red-500">{{ $message }}</p>
                        @enderror
                    </x-image-preview>
