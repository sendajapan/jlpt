...
{{-- Back Link --}}
<a href="{{ route('admin.subcategories.index') }}" class="inline-flex items-center gap-1.5 text-xs text-zinc-500 hover:text-zinc-800 transition-colors mb-4">
...
<div class="bg-white rounded-lg border border-zinc-200 overflow-hidden max-w-2xl">
    ...
    <div class="flex items-center justify-between px-5 py-3 border-b border-zinc-100">
        <span class="text-sm font-semibold text-zinc-900">New Subcategory</span>
    </div>
        ...
        <div class="px-5 py-4 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name_en" value="{{ old('name_en') }}" placeholder="e.g. Animals"
                ...
                <div>
                    ...
                    <input type="text" name="name_jp" value="{{ old('name_jp') }}" placeholder="e.g. 動物"
            ...
            <div>
                ...
                <input type="text" name="name_romaji" value="{{ old('name_romaji') }}" placeholder="e.g. doubutsu"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    @error('icon_path') <p class="mt-1 text-[10px] text-red-500">{{ $message }}</p> @enderror
                </div>
